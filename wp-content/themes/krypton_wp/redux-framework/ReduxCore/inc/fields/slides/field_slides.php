        ...
        public function render() {
           ...
           if (isset($this->value) && is_array($this->value)) {
                ...
                foreach ($slides as $slide) {
                    ...
                    echo '<li><label>'.__( 'Slide Title', 'redux-framework' ).'</label> <input type="text" id="' . $this->field['id'] . '-title_' . $x . '" name="' . $this->args['opt_name'] . '[' . $this->field['id'] . '][' . $x . '][title]" value="' . __(esc_attr($slide['title']),'Krypton') . '" class="full-text slide-title" />';
