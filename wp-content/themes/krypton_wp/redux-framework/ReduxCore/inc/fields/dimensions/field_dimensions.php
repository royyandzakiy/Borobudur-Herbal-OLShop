...
class DethemeReduxFramework_dimensions extends DethemeReduxFramework {
...
//function
    ...
    function enqueue() {
        ...
        wp_enqueue_script(
                'redux-field-dimensions-js', DethemeReduxFramework::$_url . 'inc/fields/dimensions/field_dimensions.js', array('jquery', 'select2-js', 'jquery-numeric'), time(), true
        );

        wp_enqueue_style(
                'redux-field-dimensions-css', DethemeReduxFramework::$_url . 'inc/fields/dimensions/field_dimensions.css', time(), true
        );
    }
