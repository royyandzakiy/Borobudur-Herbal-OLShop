...
class DethemeReduxFramework_select_image extends DethemeReduxFramework {
...
//function
    ...
    function enqueue() {
        wp_enqueue_script(
                'field-select-image-js', DethemeReduxFramework::$_url . 'inc/fields/select_image/field_select_image.js', array(), time(), true
        );
        
        wp_enqueue_style(
                'redux-field-select-image-css', DethemeReduxFramework::$_url . 'inc/fields/select_image/field_select_image.css', time(), true
        );
    }
