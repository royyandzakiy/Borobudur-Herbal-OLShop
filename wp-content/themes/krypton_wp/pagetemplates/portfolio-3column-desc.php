...
<section class="portfolio portfolio-with-desc">
	<div class="container">
<div class="row" >
<?php print $navbar;?>
</div>
...
<div class="row" >
	<div class="container">
	<div id="portfolios" class="portfolio-container col-3 col-xs-12">
<?php 	if(count($posts)):
		...
		if(count($navigations) && count($posts)):
			...
			print '<article class="portfolio-item more-post '.$navigation.'"><a class="btn-more" href="'.get_term_link( $navigation, 'portcat' ).'?&page=1&type=2&in='.@implode(',',$rowid).'">
