	...
	<div id="comment-<?php comment_ID(); ?>" class="comment_container">
		...
		<div class="pull-left">
			<?php 
				...
				if (isset($avatar_url)) {
			?>					
			<img src="<?php echo esc_url($avatar_url); ?>" class="author-avatar img-circle img-responsive" alt="Avatar" />
			<?php 
				} //if (isset($avatar_url))
			?>											
		...
		<div class="comment-text media-body">
			...
			<?php else : ?>
				...
				<p class="meta">
					<h4 class="media-heading pull-left" itemprop="author"><?php comment_author(); ?></h4> <?php
