	...
	class GetBowtiedUpdater {
		...
		public function upgradeFilter( $reply, $package, $updater ) {
			...
			if (  $condition ) 
			{
				...
				{
					return new WP_Error( 'no_credentials', __( 'To receive automatic updates license activation is required. Please visit <a href="' . admin_url( 'admin.php?page=getbowtied_theme_registration' ) . '' . '" target="_blank">Product Activation</a> to activate your theme.', 'getbowtied' ) );
				}
			}
