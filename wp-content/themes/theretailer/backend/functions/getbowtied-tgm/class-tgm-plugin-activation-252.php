 ...
 * @version   2.5.2 for parent theme GetBowtied for publication on ThemeForest
	...
	class TGM_Plugin_Activation {
		...
		public function filter_plugin_action_links_update( $actions ) {
			$actions['update'] = sprintf(
				...
				esc_url( add_query_arg( 'page', 'getbowtied_theme_plugins', network_admin_url( 'admin.php' ) ) ),
		...
		protected function do_plugin_install() {
			...
			if ( ( isset( $_GET['tgmpa-install'] ) && 'install-plugin' === $_GET['tgmpa-install'] ) || ( isset( $_GET['tgmpa-update'] ) && 'update-plugin' === $_GET['tgmpa-update'] ) ) {
				...
				if ( $this->is_tgmpa_complete() ) {
					// GetBowtied modification: change the return URL to plugins page
					echo '<p><a href="', esc_url( admin_url( 'admin.php?page=getbowtied_theme_plugins' ) ), '" target="_parent">', esc_html( $this->strings['return'] ), '</a></p>';
		...
		public function notices() {
			...
			if ( ! empty( $message ) ) {
				...
				$show_install_link  = $install_link_count ? '<a href="' . esc_url( add_query_arg( 'page', 'getbowtied_theme_plugins', network_admin_url( 'admin.php' ) ) ) . '">' . translate_nooped_plural( $this->strings['install_link'], $install_link_count, 'tgmpa' ) . '</a>' : '';
                $show_activate_link = $activate_link_count ? '<a href="' . esc_url( add_query_arg( 'page', 'getbowtied_theme_plugins', network_admin_url( 'admin.php' ) ) ) . '">' . translate_nooped_plural( $this->strings['activate_link'], $activate_link_count, 'tgmpa' ) . '</a>'  : '';
                $show_update_link = $update_link_count ? '<a href="' . esc_url( add_query_arg( 'page', 'getbowtied_theme_plugins', network_admin_url( 'admin.php' ) ) ) . '">' . translate_nooped_plural( $this->strings['update_link'], $update_link_count, 'tgmpa' ) . '</a>'  : '';
                ...
                $action_links = apply_filters(
                    ...
                    array(
                        ...
                        'update'   => ( current_user_can( 'update_plugins' ) ) ? $show_update_link : '',
