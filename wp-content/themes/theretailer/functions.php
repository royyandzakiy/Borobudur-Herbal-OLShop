...
function theretailer_styles() {	
	...
	wp_enqueue_style('font-awesome', get_template_directory_uri() . '/fonts/font-awesome/css/font-awesome.min.css', array(), '3.2.1', 'all' );
...
function shortcode_google_map($atts, $content=null, $code) {
	extract(shortcode_atts(array(
		...
		'color' => '#b39964',
		'zoom' => '17',
		'button_text' => __( 'Get Directions', 'theretailer' )
	), $atts));
	ob_start();	
	?>    
